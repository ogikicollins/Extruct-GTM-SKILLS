...
Day 90 agenda (Aaron + client, 60 minutes):
  ...
  3. Next 90 days options:
     ...
     c. Additional seat (second person running SELLL in another department)
...
CHS ≥ 80 triggers monthly expansion check:
  n8n monthly check (Day 30, 60, 90, 120...):
    Evaluate:
      ...
      □ Multi-team expansion? (sales + marketing both running SELLL)
...
|---------|----------------|----------|
| 2nd SDR hired | 2nd-seat SELLL setup + new sequence set | +$8K setup + $1.5K/mo |
...
| Marketing team wants pipeline | B2B marketing variant of SELLL | +$12K setup + $2.5K/mo |
...
Referred contacts enter Layer 2 Fast-Track before Layer 4:
  ...
  → See: skills/selll/layer-2/references/referral-fast-track.md for the full fast-track protocol
