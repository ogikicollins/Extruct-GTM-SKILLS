...
n8n generates quarterly report:
  ...
  - System health: all KPIs vs. Growthflare targets
...
```
THE GROWTHFLARE INTELLIGENCE FLYWHEEL
...
Monthly update: skills/growthflare/cold-call/SKILL.md → call times + script ranking
```
...
Monthly update: skills/growthflare/referral-engine/SKILL.md → timing + ask type ranking
```
