---
name: growthflare-layer-3
description: >
  Master campaign execution and intelligence skill for Layer 3 of the SELLL.io
  Growthflare Revenue Engine. Takes the verified campaign CSV from Layer 2 and
...
| Layer 2 Run Log | `skills/growthflare/layer-2/SKILL.md` → Run Log | Phase 1A (pre-launch verification) |
