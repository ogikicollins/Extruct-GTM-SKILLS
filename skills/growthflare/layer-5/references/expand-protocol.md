...
|---------|----------------|----------------|---------|
| New sales hire | Client hires 2nd SDR or new VP Sales | 2nd-seat Growthflare | Offer when hire confirmed |
...
alongside them — so the new hire is running Growthflare from day 1, not trying
...
A few clients have asked whether Growthflare works for marketing-led pipeline
...
$2,500/month for the marketing campaign. Runs separately from your sales Growthflare.
