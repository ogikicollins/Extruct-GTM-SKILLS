# VPSales_Displacement â€” Competitor Displacement Sequence
> Variant: `VPSales_Displacement`
> Persona: Persona 3 â€” New VP Sales / Head of Sales (also works for Persona 1 CRO)
...
This is both the highest opportunity and the highest risk sequence. Done right â€” empathetic, non-attacking, specific about the failure mode â€” it positions SELLL as a fundamentally different model. Done wrong â€” generic, predatory, "we're better than them" â€” it gets deleted immediately and destroys credibility.
...
## Email 1 â€” Acknowledge, Don't Attack
**Send: Day 1 (after pre-engagement complete)**
**Subject: `After {{competitor_name}} â€” {{company_name}}`**
...
Not a jab at them â€” it's a structural problem with how most outbound agencies work. They run their playbook on your ICP. The ICP was never theirs to define. So the sequences launch on intelligence that was built for a generic buyer, not your specific one.
...
## Email 2 â€” The Structural Difference
**Send: Day 4**
...
They start with the sequence. We start with three weeks of intelligence â€” ICP mapping, signal selection, competitive positioning, message architecture. That work is what determines whether the sequence performs. Skip it, and you're putting a high-quality delivery system on top of a broken foundation.
...
**Word count: 112**
**Why it works: The "three weeks of intelligence before a single email goes out" is the clearest differentiator and it's presented as a process observation, not a sales claim. The proof quote is the clincher â€” someone who came off the exact same experience and felt the difference.**

---

## Email 3 â€” The Model (Loom)
**Send: Day 8**
**Subject: `What different actually looks like â€” 4 min`**

```
{{first_name}},

I recorded a short video for {{company_name}} â€” specifically on the intelligence-first model and how it differs from what you experienced with {{competitor_name}}.

{{v_loom_url}}

No pitch. No "here's why we're better." Just the mechanism â€” the three weeks of work that runs before any email is sent â€” so you can judge whether it's actually different or just sounds different.
...
It's the internal credibility. When a VP Sales champions an outbound initiative and it underperforms, the resistance to the next initiative doubles â€” regardless of whether the next one is genuinely different.

The companies we work with that came off {{competitor_name}} almost always carry that scar tissue. The first conversation we have isn't about outbound â€” it's about rebuilding the internal case for it.
...
If the experience with {{competitor_name}} has made another outbound initiative a hard internal sell â€” I understand completely. Bad timing on my end.
...
- If `competitor_frustration_signal` column has specific wording from a G2 review or post â†’ this can be used in Email 2 instead of the generic "execution was probably fine" line
...
If the prospect left a G2 review saying "the meetings were low quality and the targeting was off" â€” replace the generic line with:

> "The targeting was off â€” that's the thing you described. It's the same structural problem."
