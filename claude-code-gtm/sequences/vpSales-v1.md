...
**Word count: 83**
**Dependency: `{{loom_url_company_specific}}` must be recorded before this email sends. If not ready, delay Email 3 by 3 days — do not send with blank URL.**
...
- Record company-specific Loom (4 minutes max)
- Reference: their company name, their SDR count, their tool stack, the proof company's result
- Script guidance in `brain/proof-library.md` → Loom Scripts section
